...
// FIX: Refactored component to use React.FC. This resolves a potential tooling issue where the 
// 'children' prop was incorrectly reported as missing, despite being provided correctly in the JSX.
// This approach aligns with similar fixes in other components within the project.
const FeatureSection: React.FC<{ title: string }> = ({ title, children }) => (
    <div>
